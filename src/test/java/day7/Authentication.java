...
public class Authentication {
	...
	public void testBearerTokenAuthentication() {
		...
		String bearerToken = System.getenv("GITHUB_TOKEN"); // In Eclipse: Right-click your project → Run As → Run
															// Configurations → Environment → New...
	...
	public void testApiAuthentication2() {
		...
		given()
				...
				.pathParam("myPath", "data/2.5/forecast/daily").queryParam("appid", "f58b4bfa57e15013799775cfc76546c5")
